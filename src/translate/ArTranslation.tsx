const ArTranslation = {
  ...
  servicesPage: {
    ...
    service1Text:
      "نعمل في طنّان على ابتكار أسلوب مثالي يحقق التوازن بين الجمال الفني والأداء الوظيفي للعلامة التجارية.",
    service2Text:
      "نستوعب احتياجك ثم نصنع لك خطة حملة تسويقية متكاملة تحقق بها مستهدفاتك وتطلعاتك.",
    service3Text:
      "لأن الكلمة تترك أثر وتغيّر خيار وتصنع قرار دائمًا نفكر بالكلمة المناسبة ونسردها بأسلوب يعبر عنك ويحقق أهدافك.",
  },
  buttons: {
    viewMore: "عرض المزيد",
  },
